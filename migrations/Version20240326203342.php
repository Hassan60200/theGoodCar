 ...
 */
final class Version20240326203342 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE car (id INT AUTO_INCREMENT NOT NULL, brand_id INT NOT NULL, car_model_id INT NOT NULL, region_id INT NOT NULL, departement_id INT NOT NULL, city_id INT NOT NULL, year_of_manufacture INT NOT NULL, color VARCHAR(15) NOT NULL, price DOUBLE PRECISION NOT NULL, fuel_type VARCHAR(20) NOT NULL, mileage INT NOT NULL, img VARCHAR(255) NOT NULL, status VARCHAR(255) NOT NULL, INDEX IDX_773DE69D44F5D008 (brand_id), INDEX IDX_773DE69DF64382E3 (car_model_id), INDEX IDX_773DE69D98260155 (region_id), INDEX IDX_773DE69DCCF9E01E (departement_id), INDEX IDX_773DE69D8BAC62AF (city_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
